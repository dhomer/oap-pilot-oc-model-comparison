createBlankTemplate('blankPilot.json','#oapPilotModel');
createBlankTemplate('blankDraft.json','#draftModel');

function createBlankTemplate(sourceFile,targetDiv) {
    d3.json(sourceFile, function(error, json){
