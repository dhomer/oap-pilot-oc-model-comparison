//comparisonMap("wextra.json","#wextra",['World Bank','Colombia','Philippines Awards','Philippines Bids','UK Bids','UK Awards','US (Partial)','OAP Pilot']);
createComparisonMap("compDraft.json","#draftModelCompare",['arr']);
createComparisonMap("compPilot.json","#pilotModelCompare",['arr']);

function createComparisonMap(jsonFilePath,targetDiv,requiredBlocks) {
    d3.json(jsonFilePath, function(error, json){
        ...
        var svg = d3.select(targetDiv).selectAll("svg")
